<div component="bottombar" class="bottombar d-flex flex-column d-lg-none fixed-top ff-secondary gap-1 align-items-center">
	...
	<div class="bottombar-nav p-2 text-dark bg-light d-flex justify-content-between align-items-center w-100">
		<div class="bottombar-nav-left d-flex gap-3 align-items-center">
			<div>
				<a href="#" role="button" class="nav-link nav-btn d-none justify-content-between align-items-center position-relative" data-bs-toggle="dropdown">
